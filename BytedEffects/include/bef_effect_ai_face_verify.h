...
#define BEF_AI_FACE_FEATURE_DIM 128  // The dimensions of facial features 人脸特征的维数


// 结果信息
typedef struct bef_ai_face_verify_info_s{
    bef_ai_face_106 base_infos[BEF_AI_MAX_FACE_VERIFY_NUM];//  基本的人脸信息，包含106点、动作、姿态
                                                        //Basic face information, including 106 points, movements and gestures
...
/**
 * 创建人脸比对的句柄
 * create a face comparison handle
 *@brief init handle 初始化handle
 *@param face_verify_param_path  face verify model file path 人脸识别模型的文件路径
 *@param max_face_num            max num of face, can not bigger than AI_MAX_FACE_NUM 要处理的最大人脸数，该值不能大于AI_MAX_FACE_NUM
...
/**
 * @brief Face feature extraction, supports up to 10 faces
 *      人脸特征提取，支持最多10个人脸
...
/**
 * @brief   Calculation of feature similarity
 *          特征相似度计算
 *
 * @param [in] d 特征距离
 *
...
/**
 * @brief face verify authorization
 *      人脸比对授权
